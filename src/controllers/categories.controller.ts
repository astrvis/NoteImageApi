...
import type {
  getArticleByCategoriesIdRoute,
  getCategoriesRoute,
} from "../routes/definition/categories.definition.js"
import { articlesCache, articlesCategoriesCache } from "../utils/lruCache.js"

export const getAllCategories: RouteHandler<typeof getCategoriesRoute> = async (c) => {
...
export const getArticleByCategoriesId: RouteHandler<typeof getArticleByCategoriesIdRoute> = async (
  c,
) => {
